            ...
            <div class="container">
              <ul class="nav">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="flight-info.php">Flight Info</a></li>
      ...
      <div class="row-fluid">
          ...
          if(isset($_POST['airline']) && isset($_POST['flightNum']))
              {
                ...
                $select_flight_info = "SELECT * FROM `FlightInfo` WHERE `airline` = '$airline' OR `flightNumber` = '$flightNum'";
                ...
                $select_flight_info = "SELECT * FROM `FlightInfo` WHERE `airline` = '$airline'";
                $result = mysqli_query($dbc, $select_flight_info);
               ...
               while($row = mysqli_fetch_array($result))
                ...
                $select_flight_info = "SELECT * FROM `FlightInfo` INNER JOIN `Airports` ON Airports.city = '$originCity' WHERE `origin` = `code`";
                $result = mysqli_query($dbc, $select_flight_info);
        ...
        <div class="span6">
          <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-horizontal">
            <fieldset>
              <legend>Flight Info - Airline OR Flight Number</legend>
          ...
          <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-horizontal">
            <fieldset>
              <legend>Flight Info - Origin City</legend>
              <div class="control-group">
