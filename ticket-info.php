            ...
            <div class="container">
              <ul class="nav">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a href="ticket-info.php">Ticket Info</a></li>
                </ul>
              </li>
              </ul>
            </div>
       ...
       <div class="row-fluid">
          ...
          if(isset($_POST['customerID']))
              {
                ...
                $select_ticket_info = "SELECT * FROM `Tickets` WHERE `airline` = '$airline' AND `flightNumber` = '$flightNumber'";
                $result = mysqli_query($dbc, $select_ticket_info);
        ...
        <div class="span6">
          <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-horizontal">
            <fieldset>
              <legend>Ticket Info - Customer ID</legend>
          ...
          <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-horizontal">
            <fieldset>
              <legend>Ticket Info - Airline + Flight Number</legend>
              <div class="control-group">
...
<!-- 
      <div class="row-fluid">
        <div class="span6">
          <form method="POST" action="ticket-info.php" class="form-horizontal">
            <fieldset>
              <legend>Ticket Info - Customer ID</legend>
              <div class="control-group">
                <label class="control-label" for="customerID">Customer ID</label>
