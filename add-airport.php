          ...
          <div class="navbar-inner">
            <div class="container">
              <ul class="nav">
                ...
                <li class="active"><a href="add-airport.php">Airport</a></li>
        ...
        <div class="span12">
          <?php
            if(isset($_POST['submit']))
            {
              ...
              if(strlen($code) == 3)
              {
                $insert_airport_query = "INSERT INTO `comp3715project1`.`Airports` (`code`, `city`, `state`) VALUES ('$code', '$city', '$state')";
                $result = mysqli_query($dbc, $insert_airport_query) or die("<div class='alert'><button type='button' class='close' data-dismiss='alert'>&times;</button><strong>Error!</strong> Inserting Airport into the database.\n" .  mysqli_error($dbc) . "</div>");
                if($result)
                {
                  echo "<div class='alert alert-success'><button type='button' class='close' data-dismiss='alert'>&times;</button><strong>Success!</strong> Airport inserted.</div>";
                }
              } else {
                echo "<div class='alert alert-error'><button type='button' class='close' data-dismiss='alert'>&times;</button><strong>Error!</strong> Code must be of length three.</div>";
              }
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="code" placeholder="LAX">
            </div>
          </div>
          <div class="control-group">
          ...
          <div class="control-group">
            <div class="controls">
              <button type="submit" name="submit" class="btn">Add Airport</button>
            </div>
          </div>
          </fieldset>
        </form>
